...
% \end{frame}
\begin{frame}{Why -- business view}
  Currently available state-of-the-art tools and systems for computational
  research could be improved.

  Researchers are slowed down by lack of good easy tools for practical
  everyday difficulties like
  \begin{itemize}
  ...
  \pause This leads to ineffective use of man and machine hours.
\end{frame}
\section{What}
...
\begin{frame}{What -- product goals}
  ...
  \begin{enumerate}
  \item visualisation and analysis of experiment data
  \item some neural networks specific functionality
  \end{enumerate}
...
\begin{frame}{For whom -- users}
  ...
  \item Computational bioscience researchers
