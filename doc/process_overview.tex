...
\begin{frame}{Teamwork sessions}
  ...
  \begin{itemize}
  \item have a Scrum and a 3h session on Wednesdays
  \item have a Scrum and a 6h session on Fridays
  \item do 2h of individual work remotely; more to cover up any missed
    sessions
  \end{itemize}
...
\begin{frame}{Communication}
  ...
  \item Skype - remote teamworking sessions
  \end{itemize}
