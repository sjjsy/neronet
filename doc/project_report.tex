...
\begin{frame}{Quality attributes}
  ...
  \end{itemize}
\end{frame}
\begin{frame}{Confessions}
  Achieving great quality was/is very challenging!

  \begin{itemize}
  \item Several issues are still unsolved
  \item More stress testing would be necessary
  \item There is room for refactoring
  \end{itemize}
\end{frame}
...
\begin{frame}{Sprints}
  \begin{itemize}
  \item S0: Prepare for project \Done{}
...
\begin{frame}{Thank you!}
  \begin{figure}
    \centering\includegraphics[width=0.8\columnwidth]{gfx/team2.jpg}
  \end{figure}
  We learned and had fun together :)
\end{frame}
\end{document}
