...
\begin{frame}{Results}{Sprint 2}
  ...
  \begin{itemize}
  \pause \item US6: as a user, I want to set preferences (name, email, default cluster) \pause \Done{}
...
\begin{frame}{Results}{Sprint 3}
  ...
  \pause Product Backlog Items: 
  \begin{itemize}
  \pause \item US11: As a user, I want to save important information about my clusters \pause \Done{}
  ...
  \pause Rewriting, refactoring and development under the hood. % In this sprint we also finished asynchronous daemon system so users could submit and manage multiple experiments and clusters, created gui and made our software to support python 2.7 and newer versions (previously only python 3.5)
\end{frame}
\begin{frame}{Results}{Sprint 4}
  ...
  \pause \item US18: As a user, I want to be able to easily visualize variable changes over time. \pause \Done{}
