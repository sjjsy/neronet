...
\def\student{Teemu Blomqvist 222804}
\input{../tex/diary.tex}
%% Content pages
Learning diary 1:
...
work on at all times, and we could ask eachother for help on problems and then
...
the defined clusters and experiments \end{document}
