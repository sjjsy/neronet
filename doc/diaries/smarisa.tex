...
According to the course material the development team should be self-organizing
and independent. However, in my opinion a group of inexperienced
...
% Erinomaista reflektointia ja syvällistä pohdintaa Scrumista ja kurssista ylipäänsä! Hienoa lukea myös ajatuksia ryhmän haasteista ja miten olette niihin reagoinut. 

\chapter{Project review II}

This entry was written on March 5, 2016 just after our second project
review. First I'll describe three of the educational observations I have
made during the second third of the project. Second, I'll summarize my
contributions to the project so far.

First of all, I wish to note that I feel that the second third of the project
was very different from the first, and in several ways:

During the first third myself and the whole team got a pretty good
understanding and working knowledge of our project, Scrum and the course and
gained important practical experience. In the second third we were able
to continue implementing adjustment ideas regarding our application of Scrum
and our teamwork methods and profit from our knowledge and experience capital.
This increase in experience and our sprint team leader system made the second
third of the project vastly easier for me as our team's scrum master and
inofficial project manager.

Clearly a major reason why the sprint was lighter for me was the fact
that many of the critical and challenging tasks that I was responsible for
such as connecting stakeholders, creating plans and designs and proposing and
teaching teamwork methods were largely done in sufficient extent and quality
during the first third.

Besides the obervation above, I wish to note the following three learning
observations:

\begin{enumerate}
\item It is difficult to say whether daily scrums and general teamwork meetings
  are effective or not. In some of our earlier retros we acknowledged that not
  all of our daily scrums looked like out of a scrum manual. In deeper
  retrospect I feel that they absolutely should not look like such when the team
  is as inexperienced as ours was. The sometimes disorderly liveliness of some
  of our daily scrums was a sign of wholehearted commitment, keen interest, and
  of a culture of inclusiveness, acceptance, and straightforward
  nonhierarchical collaboration.

  Sometimes I felt that we had wasted hours and hours on discussions from which
  I gained very little. However, in retrospect, I think those long discussions
  and debates are the reason most things have gone very smooth ever since.
\item Trying to achieve quality and good results in things that are not that
  essential by control and micro management is clearly less fruitful than
  letting everyone act pretty much the way they see fit. As a leader one must
  prioritize the long list of little things that should be followed and done
  and start by presenting the list to each team member asking which two to four
  are they willing to commit to doing.

  It can be more fruitful in the longer term if initially some little things
  are neglected or get patched in a hurry by the scrum master himself but the
  major things progress effectively while the spirit remains high and everyone
  is enjoying the project.
\item One should not be too ambitious when thinking about practices that
  one plans to be carried out in a regular basis. For example I had the idea
  that we would gather the team at the end of each sprint perhaps just after
  the retrospective and give each and every team member feedback on his/her
  contributions and collaboration style. However, even just the challenge of
  making sure we have a clearly organized retrospective as required by Scrum
  was enough. The retrospectives often took the time and energy our team had
  to spare for it and there was not enough for any additional pondering work.
  
  Also, our developers were not so interested in spending time on unrequired
  work items, perhaps rightly so.
\end{enumerate}

My main contributions are listed here: During the second third of the project I

\begin{enumerate}
\item Acted as the team's scrum master -- trying to keep up the team's working
  efficiency (work planning, motivation), scheduling and leading scrum events,
  ensuring adherence to course requirements etc.
\item Acted as lead developer for some of the most challenging parts of the
  software (logic related to asynchronous features, inter process communication
  across hosts, clusters).
\end{enumerate}

% Erinomaista reflektointia ja havaintoja! Alla omia kommenttejani jokaiseen oppimishavaintoon.
% 1. Tämä on todella arvokas havainto ja ilmiön tunnistaminen ei ole mikään helppo juttu. Omasta mielestäni ainakin osa Scrumin käytännöistä on suunniteltu aika pitkälti olemassa olevia tiimejä silmällä pitäen ja varsinaista tiimin muodostusta niissä ei ole otettu huomioon, mikä toisaalta kurssikontekstissa on oleellinen osa projektia. Lisäksi tehtävien koon estimointi ja määrittely helpottuu huomattavasti kun projekti on ns. stabiloitunut alun "sekamelskan" jälkeen. Scrumkin soveltuu sellaisenaan vain tiettyyn kontekstiin, ja ohjelmistokehitysmenetelmissä vallitseva konsensus on, että käytettävä menetelmä tulee räätälöidä projektin, ihmisten ja muiden rajoitteiden mukaan. Sinänsä Scrum itsessään mahdollistaa ja kannustaa tähän retrospektiivien avulla.
% 2. Tämäkin erittäin hyvä havainto. Westrumin typologian mukaan kontrolloidummat kulttuurit saavat aikaan huonompia tuloksia turvallisuutta korostavissa konteksteissa. Kompleksisissa tilanteissa (millaisia ohjelmistoprojektit useimmiten ovat) kenelläkään yksittäisillä henkilöllä ei ole riittävän täydellistä tietoa tilanteesta, joten päätösten tekoa on pakko jalkauttaa lattiatasolle asti.
% 3. Jälleen hyvä havainto. Projektin alussa suunnittelemanne prosessi vaikutti minusta hieman raskaalta, mutta uskoin teidän itse huomaavan asian, jos näin tulisi olemaan. Käytäntöjen vakiinnuttaminen vaatii aina kokeilua ja käytännön rutinisoituminen vaatii aikaa. Siksi usean käytännön yhtäaikainen omaksuminen voi osoittautua melko haastavaksi, kun muitakin tehtäviä on työn alla. Tähän liittyen mieleeni tuli eräs esitys Guide Boardista (https://speakerdeck.com/mattisg/the-guide-board), jonka avulla erilaisten käytäntöjen käyttöä voi seurata ja muuttaa projektin edetessä.
% Tiivistettynä: oikein esimerkillinen päiväkirja!

\chapter{Final review}

This entry was written on 12th of April, 2016 just prior to the final
submission of our project and the associated presentation and other material
for evaluation.

At the end of this project I am left with three main thoughts:

\begin{enumerate}
\item I acknowledge the fact that me and my team are only humans and our
  abilities to achieve the results we would love to see are limited.
  For example I guess since several of us have several assignment DLs and
  bachelors thesis presentations this week we will most likely be unable to
  offer our audience the learning diarys we would have hoped to offer in time.
\item However, I cannot feel but pride over the fact that we have managed this
  far with such great results. I am proud of my team and my own performance,
  even if at times clearly limited. Even though we did not reach the results
  someone could have hoped or expected I think we reached an enormous amount
  of results. While failures and shortcomings often take more room than
  successes on a person's thoughts this course has offered me and my team far
  more successes.
\item My team and I have clearly learned a lot and from a broad scale of
  competence areas. The first half was full of learning about Scrum, planning
  work and technical languages and tools. The latter half of teamwork,
  endurance, dialogue, user testing, debugging, presenting, and retrospective
  thinking. I do not know whether we should be considered of having a level
  of software development expertise and professionalism that would merit the
  word "professional" to be used of us, but at least our PO thought so, and 
  we sure ain't novices no more.
\end{enumerate}

My main contributions during the last third of the project are listed here:

\begin{enumerate}
\item I acted as the team's scrum master -- trying to keep up the team's
  working efficiency (work planning, motivation), scheduling and leading
  scrum events, ensuring adherence to course requirements etc.
\item Led the preparation and execution of our participation in meetings
  and reviews.
\end{enumerate}
