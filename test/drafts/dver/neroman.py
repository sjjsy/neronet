...
#            'user' : self.func_user
    ...
    def func_specify_user(self, name, email):
        """Update user data."""
        self.daemon.preferences['name'] = name
        self.daemon.preferences['email'] = email
        self.daemon._save_config(self.daemon.preferences_file, self.daemon.preferences)
