...
#
# Created: Sat Apr  9 16:20:03 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.nodes = QtGui.QListWidget(self.tab)
        self.nodes.setGeometry(QtCore.QRect(0, 20, 171, 151))
        self.nodes.setObjectName(_fromUtf8("nodes"))
        self.node_name_field = QtGui.QLineEdit(self.tab)
        self.node_name_field.setGeometry(QtCore.QRect(230, 20, 113, 27))
        self.node_name_field.setObjectName(_fromUtf8("node_name_field"))
        ...
        self.node_add_btn = QtGui.QPushButton(self.tab)
        self.node_add_btn.setGeometry(QtCore.QRect(230, 100, 111, 27))
        self.node_add_btn.setObjectName(_fromUtf8("node_add_btn"))
        self.node_address_field = QtGui.QLineEdit(self.tab)
        self.node_address_field.setGeometry(QtCore.QRect(230, 70, 113, 27))
        self.node_address_field.setObjectName(_fromUtf8("node_address_field"))
        self.label_3 = QtGui.QLabel(self.tab)
        self.label_3.setGeometry(QtCore.QRect(0, 0, 64, 21))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.node_type_combo = QtGui.QComboBox(self.tab)
        self.node_type_combo.setEnabled(True)
        self.node_type_combo.setGeometry(QtCore.QRect(10, 250, 16, 16))
        self.node_type_combo.setObjectName(_fromUtf8("node_type_combo"))
        self.node_type_combo.addItem(_fromUtf8(""))
        self.node_type_combo.addItem(_fromUtf8(""))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "node name", None))
        self.label_2.setText(_translate("MainWindow", "node address", None))
        self.node_add_btn.setText(_translate("MainWindow", "Add node", None))
        self.label_3.setText(_translate("MainWindow", "Nodes", None))
        self.node_type_combo.setItemText(0, _translate("MainWindow", "unmanaged", None))
        self.node_type_combo.setItemText(1, _translate("MainWindow", "slurm", None))
        self.submit_btn.setText(_translate("MainWindow", "Submit", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Node", None))
